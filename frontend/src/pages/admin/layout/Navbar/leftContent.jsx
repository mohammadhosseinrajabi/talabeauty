...
export default function LeftContent({ onClick }) {
  ...
  return (
    <div className="left_content d-flex flex-row-reverse" onClick={handleClick}>
      <i
      ...
      >
        <li className="my-2">
          <a className="dropdown-item d-block text-center">محمدحسین رجبی</a>
        </li>
